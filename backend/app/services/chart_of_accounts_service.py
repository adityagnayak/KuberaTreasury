...
UK_STANDARD_COA: list[tuple] = [
    ...
    (
        "4000",
        "Turnover — Products (Standard Rate)",
        "income",
        "revenue",
        "4000",
        "T0",
    ...
    (
        "4001",
        "Turnover — Services (Standard Rate)",
        "income",
        "revenue",
        "4001",
        "T0",
...
class ChartOfAccountsService:
    ...
    def __init__(
        self, db: AsyncSession, tenant_id: uuid.UUID, user_id: uuid.UUID | None = None
    ) -> None:
        self._db = db
